...
public class ChangeDialogFragment extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        inputTask.setText(getArguments().getString("task"));
        btnClose.setOnClickListener(v -> dismiss());
        btnAccept.setOnClickListener(v -> {
            assert getArguments() != null;
            listener.onChange(inputTask.getText().toString(), getArguments().getInt("position"));
            dismiss();
        });
